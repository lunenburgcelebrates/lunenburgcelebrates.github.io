...
(function(root, factory) {
  ...
  function handleTweets(tweets){
    if (customCallbackFunction === null) {
      ...
      while(n < x) {
        html += '<div class="twitterblock">' + tweets[n] + '</div>';
        n++;
      }
      html += '</div>';
  ...
  function strip(data) {
    return data.replace(/<b[^>]*>(.*?)<\/b>/gi, function(a,s){return s;})
        .replace(/<a[^>]*>(.*?)<\/a>/gi, function(a,s){return s;})
    ...
    callback: function(data) {
      ...
      while (n < x) {
          ...
          var op = '';
            ...
            op += '<div class="tweet"><a href="' + permalinksURL[n] +
                   '">' + strip(tweets[n].innerHTML) + '</a></div>';
            op += '<div class="user">' + strip(authors[n].innerHTML) +
                  '</div>';
    
  // Show nothing if no images present
